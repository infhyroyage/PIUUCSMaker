...
export type Note = {
  /**
   * 単ノート/ホールド/中抜きホールドの始点の譜面のブロック内での行インデックス
   * 単ノートの場合はgoalと同じ値
   */
  start: number;

  /**
   * 単ノート/ホールド/中抜きホールドの終点の譜面のブロック内での行インデックス
   * 単ノートの場合はstartと同じ値
   */
  goal: number;

  /**
   * 中抜きホールドの中間にかぶせる始点の譜面のブロック内での行インデックスの配列
   * 単ノート/中抜きの無いホールドの場合は要素数0の配列
   */
  hollowStarts: number[];

  /**
   * 中抜きホールドの中間にかぶせる終点の譜面のブロック内での行インデックスの配列
   * 単ノート/中抜きの無いホールドの場合は要素数0の配列
   */
  hollowGoals: number[];
};
