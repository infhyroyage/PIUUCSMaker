...
function MenuDrawer() {
  ...
  // TODO: 縦スクロールできるようにする
  // TODO: 最後の要素は画面底で固定にする
  return (
    <div
      className="bg-base-200 h-full transition-width duration-300 flex flex-col whitespace-nowrap box-border fixed"
      style={{
        width: `${
    ...
    >
      <ul className="menu overflow-auto p-0">
        <MenuDrawerListItem
